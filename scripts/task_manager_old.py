...
global pub, path, enable_task_manager, enable_scanning, waypoint, waypoint_id, max_waypoint_id, threshold, map_coordinates, waypoint_data, new_waypoint, tour_filename, cnt, threshold_waypoint
...
def odomCallback(odomData):
    ...
    global waypoint, waypoint_id, max_waypoint_id, threshold, map_coordinates, waypoint_data, enable_task_manager, enable_scanning, new_waypoint, tour_filename, tmp, threshold_waypoint
            ...
            if waypoint_data[waypoint_id][2] >= 1 :
                ...
                if enable_scanning :
                    ...
                    try:
                        ...
                        resp = activate_controller_client(False)
...
#                            scan_type =2
                    ...
                    try:
                        ...
                        resp = activate_controller_client(True)
                    except rospy.ServiceException, e:
                        print "Task Manager: Activate_controller service call failed: %s"%e
...
def task_manager():
    ...
    global pub, path, enable_task_manager, enable_scanning, waypoint, waypoint_id, max_waypoint_id, threshold, map_coordinates, waypoint_data, tour_filename, threshold_waypoint
