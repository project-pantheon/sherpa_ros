    ...
    if suckers_landmarks_data.size > 0:      
        ...
        for tree in final_targets:
            ...
            if tree_landmarks_dist[min_landmark_id] < threshold_tree_distance:
                ...
                tree_coords_data = numpy.append(tree_coords_data,numpy.reshape([tree_coords[0][0],tree_coords[0][1]],(1,2)),axis=0)
        ...
        print "Generating JSON outpu file.\n"
