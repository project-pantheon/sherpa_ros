...
int main(int argc, char** argv) {
  ...
  ros::Publisher left_front_axle_pub = akrm.advertise<std_msgs::Float64>("sherpa/left_front_axle_controller/command", 10);
  ros::Publisher right_front_axle_pub = akrm.advertise<std_msgs::Float64>("sherpa/right_front_axle_controller/command", 10);
  ros::Publisher left_rear_axle_pub = akrm.advertise<std_msgs::Float64>("sherpa/left_rear_axle_controller/command", 10);
  ros::Publisher right_rear_axle_pub = akrm.advertise<std_msgs::Float64>("sherpa/right_rear_axle_controller/command", 10);
